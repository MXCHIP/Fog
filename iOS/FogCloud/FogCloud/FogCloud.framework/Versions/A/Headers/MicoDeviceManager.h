...
- (void)fetchShareVercodeWithDeviceID:(NSString *)deviceID
                             andToken:(NSString *)token
                              success:(void (^)(NSDictionary *result))success
                              failure:(void (^)(NSError *error))failure;
- (void)sendCommand:(NSString *)command toDevice:(NSString *)deviceID withPassword:(NSString *)password andToken:(NSString *)token success:(void (^)(NSDictionary *result))success failure:(void (^)(NSError *error))failure;

- (void)addDeviceByVerCode:(NSString *)vercode deviceID:(NSString *)deviceID password:(NSString *)password bindingType:(NSString *)bindingType role:(NSInteger)role token:(NSString *)token success:(void (^)(NSDictionary *result))success failure:(void (^)(NSError *error))failure;
