...
- (void)startMQTTService:(NSString *)host password:(NSString *)password port:(UInt32)port clientID:(NSString *)clientID deviceID:(NSString *)deviceID usingSSL:(BOOL)usingSSL;
